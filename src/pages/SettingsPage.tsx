...
const SettingsPage: React.FC = () => {
  ...
  // ✅ VERIFIKASI DATA LOKAL (Offline Only)
        ...
        <div className="bg-white p-8 rounded-[32px] border border-slate-100 shadow-sm space-y-6 md:col-span-2">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-[10px] text-slate-400 font-bold uppercase tracking-widest">
                IndexedDB (Lokal) - Offline Only
              </p>
            </div>
          </div>

          {/* Info platform — support semua platform */}
          <div className="p-5 rounded-[24px] border flex items-start gap-4 bg-emerald-50/40 border-emerald-100">
            <div className="w-9 h-9 rounded-xl flex items-center justify-center shrink-0 mt-0.5 bg-emerald-100 text-emerald-600">
              <CheckCircle2 size={18} />
            </div>
            <div className="space-y-1">
              <p className="text-sm font-black text-emerald-700">
                ✅ Penyimpanan Lokal Mandiri Aktif
              </p>
              <p className="text-[11px] font-medium leading-relaxed text-emerald-600">
          ...
          {!syncProgress && (
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              ...
              <div className="bg-slate-50 p-4 rounded-[20px] text-center space-y-2">
                <div className="text-lg font-black text-slate-600">IndexedDB</div>
                <div className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Penyimpanan Tunggal</div>
                <div className="text-[10px] text-slate-400">Offline Only</div>
              </div>
            </div>
          )}
